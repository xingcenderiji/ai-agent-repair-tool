...
class TestAgentConfigScan(unittest.TestCase):
    ...
    def test_agent_config_scan_defaults(self):
        ...
        scan = AgentConfigScan(
            agent_id="cursor", agent_name="Cursor", agent_icon="🔵"
        )
    ...
    def test_to_dict_serialization(self):
        ...
        scan.external_plugins.append(
            PluginInfo(name="test", type=PluginType.EXTERNAL)
        )
...
""")
    ...
    def test_scan_claude_config(self):
        ...
        claude_json.write_text(
            json.dumps({"skills": {"code": True, "chat": False}})
        )
    ...
    def test_scan_vscode_based_config(self):
        ...
        pkg1.write_text(
            json.dumps({"name": "test-extension", "version": "1.0.0"})
        )
    ...
    def test_scan_extensions_directory(self):
        ...
        for i in range(3):
            ...
            pkg.write_text(
                json.dumps({"name": f"extension-{i}", "version": f"1.{i}.0"})
            )
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_unicode_in_config(self):
        ...
        config_data = {"theme": "深色主题 🌙", "language": "中文"}
        config_file.write_text(
